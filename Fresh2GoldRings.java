...
public class Fresh2GoldRings extends AbstractScript {
   ...
   //Area EDGE_BANK2 = new Area(3092, 3491, 3094, 3489, 0);
    ...
    public void onPaint(Graphics g){
        ...
        g.drawString("Gold bars: " + goldBars,20,40);
        g.drawString("State: " + state,300,20);
        ...
        if (Inventory.contains("Ring mould")) {
            ...
            if (Inventory.contains("Gold bar")) {
                ...
                if (!EDGE_FURNACE.contains(getLocalPlayer())) {
                    ...
                    AntiPattern.walkToFurnaceOrClickIt();
                }
                GameObject Furnace = GameObjects.closest("Furnace");

                if (Furnace != null && Furnace.hasAction("Smelt")) {
                    Furnace.interact("Smelt");
                    Fresh2GoldRings.sleep(2000);
                    Fresh2GoldRings.sleepUntil(() -> !getLocalPlayer().isMoving(), 10000);
                }

                    if (EDGE_FURNACE.contains(getLocalPlayer()) ) {//this means we are at the furnace
                        ...
                        if(Widgets.getWidget(446).getChild(7)!=null) {
                            ...
                            if (makeGoldRing != null) {
                                ...
                                sleepUntil(() -> !Inventory.contains("Gold bar") || Dialogues.canContinue(), 45000);
                            }
                        }
